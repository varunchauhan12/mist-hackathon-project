    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-[#0f172a] p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-green-500/20 to-green-600/10 border border-green-500/30 rounded-2xl p-6">
          ...
          <p className="text-gray-300 text-sm">Nearby Safe Zones</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-orange-500/20 to-orange-600/10 border border-orange-500/30 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-3xl font-bold text-white">8m</span>
          </div>
          ...
          {safeZones.map((zone, idx) => (
            ...
            >
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-400">{zone.distance} away</span>
                <span className="text-green-400">{zone.capacity}% capacity</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-300">
              You are a vital sensor in this system. Your reports help save lives.
            </p>
          </div>
